...
export const HomeMainExtra = () => {
    return (
        <div
            className="margin20-bottom margin20-top grid-desktop-2-nospace bg-white border-smooth card-shadow">
            <div
                className="padd10 padd60-top">
                <div
                    className="padd40-bottom">
                ...
                <ul>
                    <li
                        className="font16 margin30-bottom">
                        <h4
